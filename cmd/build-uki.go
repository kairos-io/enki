...
func NewBuildUKICmd() *cobra.Command {
	...
	c.Flags().BoolP("boot-branding-version", "", false, "Include the OS version in the boot branding")
	c.Flags().BoolP("boot-branding-cmdline", "", false, "Include the cmdline in the boot branding")
